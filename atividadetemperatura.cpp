...
{
	/* Escreva um algoritmo que solicite ao usuario a temperatura em graus celsius e retorne a a temperatura
	correspondente em graus escolhidos conforme o menu a seguir: */
